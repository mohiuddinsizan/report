...
function getSubjectWiseComment(totalPercentage) {
  ...
  if (percentage >= 50 && percentage <= 64) {
    return {
      ...
      comment:
        "এই বিষয়ে তুমি হয়তো পিছিয়ে পড়েছো। এক্ষেত্রে তোমার পড়ার ধরন পরিবর্তন করে ভুল গুলোর উপর জোর দিতে হবে যেনো প্রস্তুতি আরো দৃঢ় করা সম্ভব। প্রয়োজনে আমাদের অভিজ্ঞ মেন্টরের সহায়তা নাও।",
    };
  }
...
const commentRules = [
  ...
  },
  {
    ...
    comment:
      "তুমি ঠিক জায়গায় এগিয়ে যাচ্ছো । তবে ভুল উত্তর করে ফেলেছো ; সব উত্তর করতে হবে এই চিন্তা থেকে বেরিয়ে সঠিক উত্তর করার দিকে বেশি জোর দাও।",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    comment:
      "কোথাও কোনো সমস্যার কারণে তুমি ঠিকঠাক প্রস্তুতি নিতে পারছো না। আগে তোমার সমস্যার জায়গাটি চিহ্নিত করতে হবে প্রয়োজনে মেন্টরের সাহায্য নাও এবং আত্মবিশ্বাস বাড়াতে হবে কারণ এতে skip করা যাবে না।",
  },
  {
    id: 6,
    category: "প্রস্তুতির খুবই দুর্বল অবস্থা",
